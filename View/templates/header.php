...
<html lang="en">
    <head>
        ...
        <![endif]-->
        <script language="JavaScript" type="text/javascript" src="../web/AreaEditor/html2xhtml.min.js"></script>
        <script language="JavaScript" type="text/javascript" src="../web/AreaEditor/richtext.min.js"></script>
