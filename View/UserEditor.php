    ...
    <div class="starter-template">
        ...
        <form action="../Controller/updateUser.php" method="post">
         ...
         $aUser = User::getUserById($_GET['iduser']);
         {
             ...
             echo "<label>ID Group : " . $aUser->getIdUser() . "</label><br/></br>";
             echo "User Name: <input type=\"text\" name='Name' value='" . $aUser->getName() . "'><br/></br>";
             echo "User Adress: <input type=\"text\" name='Adresse' value='" . $aUser->getAdress() . "'></br>";
             echo " <div>";
         }
            ?>
        </br>
